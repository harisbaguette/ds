...
스타일은 **모노·에디토리얼·스튜디오**다. 영감보관함의 두 원본 포스터를 같은 컬렉션 화면에 넣어 콘텐츠를 고정했다. 서체·간격·색·선·곡선·버튼·표면의 차이를 비교하고 패턴과 스타일을 함께 저장한다. 원본 포스터는 참고 콘텐츠이며 패토브가 새로 제작한 자산이 아니다.
...
| `#6D6D65` / `#FFFFFF` | 5.22:1 | 모노 데모 보조 글자 |
| `#746E62` / `#FCFAF3` | 4.85:1 | 에디토리얼 데모 보조 글자 |
| `#687862` / `#F9FCF4` | 4.55:1 | 스튜디오 데모 보조 글자 |
...
[현재 시안](<../시안/2026-09-23/패토브-재설계/README.md>) · [전후 측정](<../시안/2026-09-23/패토브-재설계/전후-비교.json>) · [38개 실행 검사](<../시안/2026-09-23/패토브-재설계/검증-결과.json>)
